...
int stubRetZero() { return 0; }

int stubRetOne() { return 1; }

int stubRetMinusOne() { return -1; }

char stubRetZeroChar() { return 0x00; }

int amDongleInit() { return 0; }

int amDongleIsAvailable() { return 1; }

int amDongleUpdate() { return 0; }
...
int amDipswInit() { return 0; }

int amDipswSetLed() { return 0; }

int amDongleIsDevelop() { return 1; }
...
int initPatch() {
  ...
  case OUTRUN_2_SP_SDX_REVA: {
    ...
    patchMemory(0x8105317, "909090909090909090909090909090909090909090909090909"
  ...
  case INITIALD_5_EXP_20: {
    ...
    if (config->showDebugMessages == 1) {
      ...
      setVariable(0x093f7244,
                  0x0FFFFFFF); // s_logMask
  ...
  case HUMMER_EXTREME: {
    ...
    // While we can't get into the test menu, immidiately return from the call
    // to clSteerErrorDisp::run that complains about the calibration values.
